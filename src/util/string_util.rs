pub fn remove_prefix_and_update_lines(
    text: String,
    prefix_number: usize,
    lines_length: usize,
    lines_offset: usize,
...
mod remove_prefix_and_update_lines_tests {
    ...
    fn test_1() {
        assert_eq!(
            "12312",
            remove_prefix_and_update_lines("123123".to_string(), 0, 5, 0, 10)
        )
    }
    ...
    fn test_2() {
        assert_eq!(
            "123123",
            remove_prefix_and_update_lines("123123".to_string(), 0, 6, 0, 10)
        )
    }
    ...
    fn test_3() {
        assert_eq!(
            "12\n12",
            remove_prefix_and_update_lines("123\n123".to_string(), 0, 2, 0, 10)
        )
    }
